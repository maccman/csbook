...
The rest of this chapter is going to be exploring how to actually structure and deploy CoffeeScript client side applications. If you're just using CoffeeScript on the server side, or your framework, such as Rails, already manages this, feel free to skip to the next chapter.
